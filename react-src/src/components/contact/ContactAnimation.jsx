...
const Contact = () => {
  ...
  const onSubmit = async (data, e) => {
    try {
      const serviceID = "service_z9kt685";
      const templateID = "template_5z8sc9e";
      const userID = "m6DgIB3HLHrew0noL";

      await emailjs.send(serviceID, templateID, data, userID);

      console.log("Message submitted successfully: " + JSON.stringify(data));
